...
typedef CreateBloc<T extends SkinnyStore<dynamic>> = T Function(
...
/// ```
/// {@endtemplate}
class BlocProvider<T extends SkinnyStore<Object>>
  ...
  /// ```
  static T of<T extends SkinnyStore<Object>>(BuildContext context) {
    try {
...
extension BlocProviderExtension on BuildContext {
  ...
  /// ```
  C bloc<C extends SkinnyStore<Object>>() => BlocProvider.of<C>(this);
}
